...
layers = [
    ...
    convolution2dLayer(8,10,'Padding',[2 2],'Stride', [1,1]);  % convolution layer with 10, 5x5 filters
    reluLayer();  % ReLU layer
    convolution2dLayer(7,20,'Padding',[2 2],'Stride', [1,1]);  % convolution layer with 20, 3x3 filters
    reluLayer();  % ReLU layer
    maxPooling2dLayer(2,'Stride',2); % Max pooling layer
    convolution2dLayer(6,30,'Padding',[1 1],'Stride', [1, 1]);  % convolution layer with 10, 5x5 filters
    reluLayer();  % ReLU layer
    convolution2dLayer(5,30,'Padding',[1 1],'Stride', [1,1]);  % convolution layer with 20, 3x3 filters
    reluLayer();  % ReLU layer
    maxPooling2dLayer(2,'Stride',2); % Max pooling layer
    convolution2dLayer(3,20,'Padding',[2 2],'Stride', [1,1]);  % convolution layer with 10, 5x5 filters
    reluLayer();  % ReLU layer
    convolution2dLayer(3,10,'Padding',[1 1],'Stride', [1,1]);  % convolution layer with 20, 3x3 filters
    reluLayer();  % ReLU layer
    maxPooling2dLayer(2,'Stride',2); % Max pooling layer
